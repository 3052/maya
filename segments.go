...
// generateSegments centralizes the logic to produce a list of segments for a Representation.
// It handles SegmentBase (sidx), SegmentTemplate (timeline/duration), and SegmentList.
func generateSegments(rep *dash.Representation) ([]segment, error) {
   ...
   return []segment{{url: baseURL}}, nil
}
