...
// is stopped cleanly. It records the segment count as plain text; the
// sample tables needed to resume live in the moov that the stop appends to
// the output file itself, and sofia.StateFromMoov rebuilds the remuxer
// state from them. Streams written without remuxing are not resumable and
// get no sidecar.
