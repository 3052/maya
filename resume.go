...
// where chunks is a comma-separated list of "offset,count" pairs and samples
// is a comma-separated list of "duration,size,sync,compositionOffset"
// groups. Both list fields are empty for streams written without remuxing.
